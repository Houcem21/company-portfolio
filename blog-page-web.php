...
<main>
  ...
  <section class="previews">
    <div>
      ...
      <figure class="absolute-bg preview__img" style="background-image: url('res/blog-images/Data/automatisme-industriel.jpg');"></figure>    
  ...
  <section class="previews">
    <div>
      ...
      <figure class="absolute-bg preview__img" style="background-image: url('https://unsplash.it/2000/1200?image=433'); width: 60%;"></figure>
      <figure class="absolute-bg preview__img" style="background-image: url('https://unsplash.it/2000/1200?image=40');"></figure>
      <figure class="absolute-bg preview__img" style="background-image: url('res/blog-images/Data/dxkvmbsdvb.pngg');"></figure>    
      <div class="previews__container">
        <span>Welcome to</span>
        <h1>Web</h1>
      </div>
  ...
  <section class="previews">
    <div>
      ...
      <figure class="absolute-bg preview__img" style="background-image: url('https://unsplash.it/2000/1200?image=433'); width: 60%;"></figure>
      <figure class="absolute-bg preview__img" style="background-image: url('https://unsplash.it/2000/1200?image=40');"></figure>
      <figure class="absolute-bg preview__img" style="background-image: url('res/blog-images/Data/lsnvp,sb.jpg');"></figure>    
      <div class="previews__container">
        <span>Welcome to</span>
        <h1>Web</h1>
      </div>
  ...
  <section class="previews">
    <div>
      ...
      <figure class="absolute-bg preview__img" style="background-image: url('https://unsplash.it/2000/1200?image=433'); width: 60%;"></figure>
      <figure class="absolute-bg preview__img" style="background-image: url('https://unsplash.it/2000/1200?image=40');"></figure>
      <figure class="absolute-bg preview__img" style="background-image: url('res/blog-images/Data/suodvhsv.jpg');"></figure>    
      <div class="previews__container">
        <span>Welcome to</span>
        <h1>Web</h1>
      </div>
